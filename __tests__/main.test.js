...
describe('DNS Server - RFC 1035 Compliance', () => {
  ...
  describe('RFC 1035 Section 4.1.3 - Resource Records (Answer Section)', () => {
    test('NAME field matches question domain', () => {
      ...
      const buf = require('../app/dns/helpers/build_answer')([domain, 1, 1, 300, 4, Buffer.from([192, 0, 2, 1])]);
    ...
    test('TYPE field specifies resource record type', () => {
      ...
      types.forEach(type => {
        const buf = require('../app/dns/helpers/build_answer')(['example.com', type, 1, 300, 4, Buffer.from([192, 0, 2, 1])]);
    ...
    test('CLASS field specifies resource class', () => {
      ...
      const buf = require('../app/dns/helpers/build_answer')(['example.com', 1, 1, 300, 4, Buffer.from([192, 0, 2, 1])]);
    ...
    test('TTL is unsigned 32-bit integer', () => {
      ...
      ttlValues.forEach(ttl => {
        const buf = require('../app/dns/helpers/build_answer')(['example.com', 1, 1, ttl, 4, Buffer.from([192, 0, 2, 1])]);
    ...
    test('TTL zero indicates no caching', () => {
      ...
      const buf = require('../app/dns/helpers/build_answer')(['example.com', 1, 1, 0, 4, Buffer.from([192, 0, 2, 1])]);
      const ttlValue = buf.readUInt32BE(17);
    ...
    test('RDLENGTH specifies RDATA field length', () => {
      ...
      const buf = require('../app/dns/helpers/build_answer')(['example.com', 1, 1, 300, rdata.length, rdata]);
    ...
    test('RDATA contains IPv4 address for A records', () => {
      ...
      const buf = require('../app/dns/helpers/build_answer')(['example.com', 1, 1, 300, ipAddress.length, ipAddress]);
    ...
    test('RDATA contains IPv6 address for AAAA records', () => {
      ...
      const buf = require('../app/dns/helpers/build_answer')(['example.com', 28, 1, 300, ipv6Address.length, ipv6Address]);
  ...
  describe('RFC 1035 Section 6 - Implementation Notes', () => {
    ...
    test('question and answer sections are properly structured', () => {
      ...
      const answer = require('../app/dns/helpers/build_answer')(['example.com', 1, 1, 300, 4, Buffer.from([192, 0, 2, 1])]);
  ...
  describe('Edge Cases and Error Handling', () => {
    ...
    test('handles maximum TTL value', () => {
      ...
      const buf = require('../app/dns/helpers/build_answer')(['example.com', 1, 1, maxTTL, 4, Buffer.from([192, 0, 2, 1])]);
